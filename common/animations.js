/*
* 这是一个JavaScript代码块，其中包含了两个函数和一个常量对象。

常量对象 Page 包括三个属性 variants、transition 和 exit，用于定义页面的动画效果。

第一个函数 createParticle 接受两个参数 x 和 y，用于在页面上创建一个随机颜色的小球，其运动轨迹由CSS动画控制。
